# Design Specification: mcp-alphabanana v2.0 (Nano Banana 2 Support)

## 1. Overview

This update upgrades **mcp-alphabanana** to support **Nano Banana 2 (Gemini 3.1 Flash Image)**. It introduces ultra-fast 0.5K drafting, improved multi-image reasoning, thinking processes, and grounding search. It also extends the transparency pipeline to support **WebP**.

## 2. Model Specifications & Compatibility

To ensure a smooth transition for existing MCP clients (GitHub Copilot, Claude Desktop, etc.), we implement a mapping layer.
